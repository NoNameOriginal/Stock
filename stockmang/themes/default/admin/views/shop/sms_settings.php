                ...
                <div class="row">
                    ...
                    <div class="Custom dn">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <?= form_input('Custom_param1_key', set_value('Custom_param1_key', $sms_settings->config->{$sms_settings->config->gateway}->params->keys->param1), 'placeholder="Name" class="form-control tip" id="Custom_param1_key"'); ?>
                                </div>
                                <div class="col-md-6">
                                    <?= form_input('Custom_param1_value', set_value('Custom_param1_value', $sms_settings->config->{$sms_settings->config->gateway}->params->others->{$sms_settings->config->{$sms_settings->config->gateway}->params->keys->param1}), 'placeholder="Value" class="form-control tip" id="Custom_param1_value"'); ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <?= form_input('Custom_param2_key', set_value('Custom_param2_key', $sms_settings->config->{$sms_settings->config->gateway}->params->keys->param2), 'placeholder="Name" class="form-control tip" id="Custom_param2_key"'); ?>
                                </div>
                                <div class="col-md-6">
                                    <?= form_input('Custom_param2_value', set_value('Custom_param2_value', $sms_settings->config->{$sms_settings->config->gateway}->params->others->{$sms_settings->config->{$sms_settings->config->gateway}->params->keys->param2}), 'placeholder="Value" class="form-control tip" id="Custom_param2_value"'); ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <?= form_input('Custom_param3_key', set_value('Custom_param3_key', $sms_settings->config->{$sms_settings->config->gateway}->params->keys->param3), 'placeholder="Name" class="form-control tip" id="Custom_param3_key"'); ?>
                                </div>
                                <div class="col-md-6">
                                    <?= form_input('Custom_param3_value', set_value('Custom_param3_value', $sms_settings->config->{$sms_settings->config->gateway}->params->others->{$sms_settings->config->{$sms_settings->config->gateway}->params->keys->param3}), 'placeholder="Value" class="form-control tip" id="Custom_param3_value"'); ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <?= form_input('Custom_param4_key', set_value('Custom_param4_key', $sms_settings->config->{$sms_settings->config->gateway}->params->keys->param4), 'placeholder="Name" class="form-control tip" id="Custom_param4_key"'); ?>
                                </div>
                                <div class="col-md-6">
                                    <?= form_input('Custom_param4_value', set_value('Custom_param4_value', $sms_settings->config->{$sms_settings->config->gateway}->params->others->{$sms_settings->config->{$sms_settings->config->gateway}->params->keys->param4}), 'placeholder="Value" class="form-control tip" id="Custom_param4_value"'); ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <?= form_input('Custom_param5_key', set_value('Custom_param5_key', $sms_settings->config->{$sms_settings->config->gateway}->params->keys->param5), 'placeholder="Name" class="form-control tip" id="Custom_param5_key"'); ?>
                                </div>
                                <div class="col-md-6">
                                    <?= form_input('Custom_param5_value', set_value('Custom_param5_value', $sms_settings->config->{$sms_settings->config->gateway}->params->others->{$sms_settings->config->{$sms_settings->config->gateway}->params->keys->param5}), 'placeholder="Value" class="form-control tip" id="Custom_param5_value"'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
