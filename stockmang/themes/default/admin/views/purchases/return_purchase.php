                    ...
                    ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('order_discount', (isset($_POST['rediscount']) ? $_POST['rediscount'] : $inv->order_discount > 0 ? $this->sma->formatDecimal($inv->order_discount_id) : ''), 'class="form-control input-tip" id="rediscount" required="required"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
